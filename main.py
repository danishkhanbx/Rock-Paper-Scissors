...
# Update messages:
# Update message parameter x carries the result in words of the game just played, 
# it will be displayed just below the buttons
def updateMessage(x):
    msg['text'] = x
...
# Buttons:
# Buttons used for declaring users move, and sending users move to updateChoice function
# to compare the choices of computer vs. user and respectively updating Scores.
